...
function TServerMethods1Client.UserList: TDataSet;
begin
  var LCommand := GetDBXCommand('UserService', 'Select');
  try
    LCommand.ExecuteUpdate;
    Result := LCommand.Parameters[0].Value.GetDa
  finally
    LCommand.Free;
  end;
end;
